    ...
    <form @submit.prevent="updatePassword" class="md:mx-24">
        ...
        <div class="relative">
            <input :type="showCurrentPassword ? 'text' : 'password'"
                ...
                placeholder="Enter your Current Password" class="w-full bg-slate-200 border rounded-md mb-5 py-2 px-3" />
        ...
        <div class="relative">
            <input :type="showPasswordConfirm ? 'text' : 'password'"
                ...
                placeholder="Confirm Password" class="w-full bg-slate-200 border rounded-md mb-5 py-2 px-3" />
            <div class="absolute top-0 bottom-5 right-0 pr-3 flex text-sm leading-5">
                <!-- toggle password confirm -->
